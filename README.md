...
In many enterprise domains, transferring vital and sensitive data into cloud repositories are not allowed due to security issues, government regulations, data governance and possible loss of vital proprietary data due to data breaches incidences. 
